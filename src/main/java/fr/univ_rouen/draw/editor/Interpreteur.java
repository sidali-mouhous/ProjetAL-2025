        ...
        try {
            switch (cmd) {
                case "line":
                    ...
                    break;
                case "rect":
                    dessin.ajouterForme(new Rectangle(Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]), Integer.parseInt(args[4]), args[5]));
                    break;
                case "circ":
                    dessin.ajouterForme(new Cercle(Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]), args[4]));
                    break;
                case "elli":
                    dessin.ajouterForme(new Ellipse(Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]), Integer.parseInt(args[4]), args[5]));
                    break;
                case "new":
                    dessin.vider();
                    break;
                ...
                case "save":
                    ...
                    break;
                case "load": // AJOUT ICI pour pouvoir charger depuis le terminal
